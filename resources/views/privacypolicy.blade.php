    ...
    <div class="container mx-auto max-w-4xl rounded-xl {{ session('message') ? 'border-red-500 border-t-8' : '' }}">
        ...
        <div class="bg-white dark:bg-neutral-800 border border-gray-200 dark:border-neutral-700  shadow-xl p-8 mb-8">
            ...
            <div class="prose dark:prose-invert max-w-none text-gray-600 dark:text-gray-300 mb-6">
                This should give you an idea of what I will do with your data. I am not a lawyer, and I am too poor to get a legal team.
            </div>
            ...
            <div class="mb-8">
                ...
                <div class="max-w-none text-gray-600 dark:text-gray-300 mb-3">
                    Ahead of you reading what I keep on you and what I track, I should clarify the purpose of meetup.mu. This project is a community project - it is developed by numerous contributors. I (<a href="https://alexbissessur.dev" class="underling !text-blue-600">Alex</a>)am the "main" developer behind. meetup.mu is intended as a free (both in freedom and cost) alternative to other platforms, built for tech community groups in Mauritius.
                    Personally, I do not care about your data.
                </div>
                ...
                <div class="max-w-none text-gray-600 dark:text-gray-300 mb-3">
                    <ul class="list-disc list-inside">
                        ...
                        <li>If you use this website without creating an account here, I store no data on you beyond the session details (as is default for Laravel).</li>
                        <li>When creating an account, you provide me with your name, email address, and a password. As expected, the password is hashed.</li>
                        <li>The only plaintext data is therefore your name and email address.</li>
                    </ul>
                </div>
                ...
                <div class="max-w-none text-gray-600 dark:text-gray-300 mb-3">
                    <ul class="list-disc list-inside">
                        ...
                        <li>Your data resides in Longhorn, a block storage solution for Kubernetes. It offers encryption at rest. However, I do not use this feature as I am unfamiliar with it.</li>
                        <li>All data is backed up to Wasabi S3 on a daily basis. Please read their docs on security <a class="!text-blue-600 underline" href="https://docs.wasabi.com/v1/docs/how-secure-is-my-data-1">here</a>.</li>
                    </ul>
                </div>
                ...
                <div class="prose dark:prose-invert max-w-none text-gray-600 dark:text-gray-300 mb-3">
                    <ul class="list-disc list-inside">
                        <li>I, Alex, have access to the entire database. This means I can see your name and email address, as well as the session details.</li>
                        <li>Your name and email address are visible to the admins of the community groups when you RSVP to their meetups.</li>
                ...
                <div class="prose dark:prose-invert max-w-none text-gray-600 dark:text-gray-300 mb-3">
                    <ul class="list-disc list-inside">
                        ...
                        <li>I am the only person who can (and will) add or remove community groups from this platform.</li>
