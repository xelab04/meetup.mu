...
<section class="mt-12 w-full px-4 container mx-auto max-w-4xl group hover:scale-105 duration-300">
    <div class="relative border border-gray-200 dark:border-neutral-700 p-8 rounded-xl shadow-red-700 hover:shadow-red-700 shadow-lg hover:shadow-2xl transition-shadow bg-white bg-opacity-90 dark:bg-neutral-800 dark:bg-opacity-90">
